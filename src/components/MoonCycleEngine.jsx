...
export default function MoonCycleEngine({ moon, onOpenDreamBottle, t }) {
  ...
  return (
    <section className="full-section moon-section">
      <div className="moon-engine">
        <div className="moon-summary-card">
          ...
          <div className="moon-summary-chips">
            <div className="moon-summary-chip">
              <span>{t("moon.metric.action")}</span>
              <strong>{moon.actionScore}/100</strong>
            </div>
            <div className="moon-summary-chip">
              <span>{t("moon.metric.tone")}</span>
              <strong>{moon.tone}</strong>
            </div>
            <div className="moon-summary-chip">
              <span>{t("moon.progressLabel", { progress: moon.progressPct })}</span>
            </div>
          </div>
          <button
            type="button"
